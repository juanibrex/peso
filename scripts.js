...
function pesaje(){
  ...
  for(var w of sistemaSolar){
    if(pesoUsuario > 0){
      ...
      resultado.innerHTML += '<div class="main-content__item"><span class="main-content__item--name">' + w.nombre + '</span><span class="main-content__item--weight">' + pesoFinal + ' Kg</span></div>';
    }
  }
